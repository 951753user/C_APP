...
//
//     final recentMatchesModel = recentMatchesModelFromJson(jsonString);

import 'dart:convert';

RecentMatchesModel recentMatchesModelFromJson(String str) => RecentMatchesModel.fromJson(json.decode(str));

String recentMatchesModelToJson(RecentMatchesModel data) => json.encode(data.toJson());
...
class RecentMatchesModel {
  ...
  factory RecentMatchesModel.fromJson(Map<String, dynamic> json) => RecentMatchesModel(
