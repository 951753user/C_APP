...
//
//     final teamDetailsResultModel = teamDetailsResultModelFromJson(jsonString);

import 'dart:convert';

TeamDetailsResultModel teamDetailsResultModelFromJson(String str) => TeamDetailsResultModel.fromJson(json.decode(str));

String teamDetailsResultModelToJson(TeamDetailsResultModel data) => json.encode(data.toJson());

class TeamDetailsResultModel {
  TeamDetailsResultModel({
    this.teamMatchesData,
  });

  List<TeamMatchesDatum>? teamMatchesData;

  factory TeamDetailsResultModel.fromJson(Map<String, dynamic> json) => TeamDetailsResultModel(
