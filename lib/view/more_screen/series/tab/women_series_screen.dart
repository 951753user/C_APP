...
class WomenSeriesScreen extends StatefulWidget {
  const WomenSeriesScreen({Key? key}) : super(key: key);

  @override
  State<WomenSeriesScreen> createState() => _WomenSeriesScreenState();
}

class _WomenSeriesScreenState extends State<WomenSeriesScreen> {
  ...
  Widget build(BuildContext context) {
    return setTime == false?Center(
      ...
      children: [
        Flexible(
          child: FutureBuilder(
            future: controller.getSeriesWomenData(),
