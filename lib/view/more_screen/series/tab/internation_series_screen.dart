...
class InternationalSeriesScreen extends StatefulWidget {
  const InternationalSeriesScreen({Key? key}) : super(key: key);

  @override
  State<InternationalSeriesScreen> createState() =>
      _InternationalSeriesScreenState();
}

class _InternationalSeriesScreenState extends State<InternationalSeriesScreen> {
  ...
  Widget build(BuildContext context) {
    return setTime == false?Center(
      ...
      children: [
        Flexible(
          child: FutureBuilder(
            future: controller.getSeriesInternationalData(),
