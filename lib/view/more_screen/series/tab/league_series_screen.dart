...
class LeagueSeriesScreen extends StatefulWidget {
  const LeagueSeriesScreen({Key? key}) : super(key: key);

  @override
  State<LeagueSeriesScreen> createState() => _LeagueSeriesScreenState();
}

class _LeagueSeriesScreenState extends State<LeagueSeriesScreen> {
  ...
  Widget build(BuildContext context) {
    return setTime == false?Center(
      ...
      children: [
        Flexible(
          child: FutureBuilder(
            future: controller.getSeriesLeagueData(),
